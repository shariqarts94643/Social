        ...
        <div class="container">
            ...
            <div class="team-members border-bottom-theme-colored2px text-center maxwidth400 mb-30">
                <div class="team-thumb">
                    <img class="img-fullwidth" alt="" src="<?php echo esc_url_raw( $img ); ?>">
                </div>
                <div class="student-details">

                        <h4 class="text-uppercase text-theme-colored font-weight-600 m-5"><?php echo esc_attr( $student['name'] ); ?></h4>
