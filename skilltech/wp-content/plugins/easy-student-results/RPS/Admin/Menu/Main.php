...
class RPS_Admin_Menu_Main {
    ...
    public function departmentMenu() {
        self::$slug['department'] = add_submenu_page(RPS_Result_Management::PLUGIN_SLUG, __('Easy Student Results', $this->TD) . ' - ' . __("Department", $this->TD), __("Branch", $this->TD), $this->role, RPS_Result_Management::PLUGIN_SLUG, array($this,'department'));
