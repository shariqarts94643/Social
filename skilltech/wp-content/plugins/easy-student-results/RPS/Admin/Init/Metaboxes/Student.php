...
final class RPS_Admin_Init_Metaboxes_Student {
    ...
    ?>
        <table class="form-table" id="student_faculty_meta">
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="department_id"><?php _e('Institute Branch',$this->TD); ?> * </label>
                </th>
                <td>
    ...
    ?>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="m_name"><?php _e('Husband\'s Name',$this->TD); ?></label>
                </th>
                <td>
    ...
    ?>    
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="guardian_contact_no"><?php _e('Home Contact No',$this->TD); ?></label>
                </th>
                <td>
