 ...
 * Class Definition.
 */
class unbound_Facebook_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'unbound_facebook_widget',
			// Widget name will appear in UI.
			esc_html__( 'Unbound Facebook Page Box', 'unbound' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for facebook box.', 'unbound' ),
			)
		);
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page-url' ) ); ?>"><?php esc_html_e( 'Page URL:', 'unbound' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page-tabs' ) ); ?>"><?php esc_html_e( 'Tabs to render i.e. events, messages(timeline is default):', 'unbound' ); ?></label>
			...
			<label><?php esc_html_e( 'Events', 'unbound' ); ?></label>
			...
			<label><?php esc_html_e( 'Messages', 'unbound' ); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width:', 'unbound' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height:', 'unbound' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'small_header' ) ); ?>"><?php esc_html_e( 'Use the small header instead:', 'unbound' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'adapt_container_width' ) ); ?>"><?php esc_html_e( 'Try to fit inside the container width:', 'unbound' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover' ) ); ?>"><?php esc_html_e( 'Hide cover photo in the header:', 'unbound' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_facepile' ) ); ?>"><?php esc_html_e( 'Show profile photos when friends like this:', 'unbound' ); ?></label>
 ...
 */
function unbound_load_widget() {
	register_widget( 'unbound_Facebook_Widget' );
}
add_action( 'widgets_init', 'unbound_load_widget' );
