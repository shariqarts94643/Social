jQuery(document).ready(function(){
	jQuery(".radiantthemes-accordion.element-six").each(function(){
		...
		jQuery(this).find(".radiantthemes-accordion-item-title").click(function(){
			jQuery(".radiantthemes-accordion.element-six").find(".radiantthemes-accordion-item-body").slideUp("500");
			jQuery(".radiantthemes-accordion.element-six").find(".radiantthemes-accordion-item").removeClass("radiantthemes-active");
