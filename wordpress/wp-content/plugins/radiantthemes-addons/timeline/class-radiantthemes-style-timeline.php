...
if ( ! class_exists( 'RadiantThemes_Style_Timeline' ) ) {
	...
	class RadiantThemes_Style_Timeline {
		...
		public function radiantthemes_timeline_style_func( $atts, $content = null, $tag ) {
            ...
            .radiantthemes-timeline.element-two.{$random_class} > .radiantthemes-timeline-item:after,
			...
			wp_add_inline_style( 'radiantthemes_timeline_' . $shortcode['radiant_timeline_style'], $custom_css );
