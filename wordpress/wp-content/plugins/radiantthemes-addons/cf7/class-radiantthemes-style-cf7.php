...
.radiant-contact-form.' . $random . ' .form-row input[type=button],.radiant-contact-form.' . $random . ' .form-row button[type=submit] {  ' . $submit_background_color . $submit_text_color . $rtsubmitborder .' }';
