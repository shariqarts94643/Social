...
$output  = '<div class="rt-portfolio-box-filter element-eight filter-style-' . esc_attr( $shortcode['portfolio_filter_style'] ) . ' text-' . esc_attr( $shortcode['portfolio_filter_alignment'] ) . ' ' . esc_attr( $hidden_filter ) . '">';
...
$output .= '</div>';
$output .= '<div class="rt-portfolio-box element-eight row isotope ' . esc_attr( $enable_zoom ) . '" data-portfolio-box-align="' . esc_attr( $shortcode['portfolio_box_alignment'] ) . '" style="margin-left:-' . esc_attr( $spacing_value ) . 'px; margin-right:-' . esc_attr( $spacing_value ) . 'px;">';
		...
		$output .= $portfolio_item_class . '" '.$time.' style="padding:' . esc_attr( $spacing_value ) . 'px;">';
    		$output .= '<div class="holder">';
    		    $output .= '<div class="pic">';
    		        ...
    		        $output .= '<div class="overlay-title">';
            		...
            		$output .= '<div class="overlay-data">';
            		    $output .= '<div class="row">';
            		        $output .= '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-left">';
            		        ...
            		        $output .= '</div>';
            		        $output .= '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">';
