...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	require 'inc/bakery-template/templates/templates-init.php';
	require 'inc/bakery-template/templates-panel.php';
}


add_action( 'admin_enqueue_scripts', 'radiantthemes_load_vc_admin_scripts' );
radiantthemes_templates();

/**
 * Function radiantthemes_templates
 */
function radiantthemes_templates() {
	if ( class_exists( 'WPBakeryShortCode' ) ) {
		$RadiantthemesTemplates = new Radiantthemes_Vc_Templates_Panel_Editor();
		return $RadiantthemesTemplates->init();
	}
}

/**
 * Admin scripts for WP Visual Bakery
 */
function radiantthemes_load_vc_admin_scripts() {

	wp_register_style(
		'radiantthemes_addon_backend_style',
		plugins_url( 'radiantthemes-addons/inc/admin/assets/css/radiantthemes_vc_backend.css' )
	);
	wp_enqueue_style( 'radiantthemes_addon_backend_style' );

	wp_register_script(
		'radiantthemes_addon_backend_script',
		plugins_url( 'radiantthemes-addons/inc/admin/assets/js/radiantthemes_addon_backend.js' ),
		array( 'jquery' ),
		false,
		true
	);
	wp_enqueue_script( 'radiantthemes_addon_backend_script' );
